...
class WoodFrameCalculationScreen extends ConsumerStatefulWidget {
  const WoodFrameCalculationScreen({super.key});

  @override
  ConsumerState<WoodFrameCalculationScreen> createState() =>
      _WoodFrameCalculationScreenState();
}

class _WoodFrameCalculationScreenState
    extends ConsumerState<WoodFrameCalculationScreen> {
  // THEME ACCENTS
  ...
  void _calculate() {
    ...
    savewoodframeHistory(length, width, depth, totalVolume);
  }

  Future<void> savewoodframeHistory(
    double length,
    double width,
    double depth,
    double volume,
    ...
    final newHistoryItem = WoodFrameHistoryItem(
      length: length,
      width: width,
      depth: depth,
      volume: volume,
    ...
    ref
        ...
        .addWoodFrameHistory(newHistoryItem);
  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (selectedUnit == 'Meter/CM') ...[
              ...
              const SizedBox(height: 12),
              _metricDual('Depth', widM, widCM, textColor),
              const SizedBox(height: 12),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [

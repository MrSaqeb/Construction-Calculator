...
part of 'square_bar_history_item.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SquareBarHistoryItemAdapter extends TypeAdapter<SquareBarHistoryItem> {
  @override
  final int typeId = 28;

  @override
  SquareBarHistoryItem read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return SquareBarHistoryItem(
      side: fields[0] as double,
  ...
  @override
  void write(BinaryWriter writer, SquareBarHistoryItem obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.side)
  ...
  bool operator ==(Object other) =>
      ...
      other is SquareBarHistoryItemAdapter &&
